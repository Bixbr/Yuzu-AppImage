...
ICON="https://git.bixed.xyz/Bix/yuzu/raw/branch/main/dist/qt_themes/default/icons/256x256/yuzu.png"
ICON_BACKUP="https://free-git.org/Emulator-Archive/torzu/raw/branch/master/dist/yuzu.png"

if [ "$1" = 'v3' ]; then
	echo "Making x86-64-v3 build of Yuzu"
	ARCH="${ARCH}_v3"
fi
...
# BUILD TORZU
if [ ! -d ./yuzu ]; then
	git clone https://git.bixed.xyz/Bix/yuzu yuzu
fi
cd ./yuzu
...
./uruntime --appimage-mkdwarfs -f \
	...
	--header uruntime \
	-i ./AppDir -o Yuzu-"$VERSION"-anylinux-"$ARCH".AppImage
